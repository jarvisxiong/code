package com.ffzx.bi.common.util;
 ...
 */
public class ExecRepositoryTransUtil {
	
	private static Logger log = FFLogFactory.getLog(ExecRepositoryTransUtil.class);
	...
	public static void main(String[] args) {
		...
		//runJob(fname);
		executeEtl("goods_arrival","/ffzx_bi/goods_arrival",0);
	 ...
	 * @since JDK 1.7
	 */
	public static void executeEtl(String name,String directoryName,int etlType){
	...
	public static void dbResourceForJob(String name,String directoryName) {
		String host = System.getProperty("kettle.host").trim();
		String db = System.getProperty("kettle.db").trim();
		String port = System.getProperty("kettle.port").trim();
		String username = System.getProperty("kettle.username").trim();
		String password = System.getProperty("kettle.password").trim();
		String repositoryUsername = System.getProperty("kettle.repository.username").trim();
		String repositoryassword = System.getProperty("kettle.repository.password").trim();
		KettleDatabaseRepository rep = null ;
		try {
			KettleEnvironment.init();
			DatabaseMeta dataMeta = new DatabaseMeta("ffzx_bi", "MYSQL", "JDBC", host, db, port, username,password);

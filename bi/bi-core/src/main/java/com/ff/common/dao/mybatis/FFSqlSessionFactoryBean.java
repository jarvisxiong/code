...
public class FFSqlSessionFactoryBean extends SqlSessionFactoryBean
{
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException
	{
		...
		FFXmlConfigBuilder xmlConfigBuilder = null;
		if (this.configLocation != null)
		{
			xmlConfigBuilder = new FFXmlConfigBuilder(this.configLocation.getInputStream(), null,
		...
		} else
		{
			...
			configuration = new FFConfiguration();

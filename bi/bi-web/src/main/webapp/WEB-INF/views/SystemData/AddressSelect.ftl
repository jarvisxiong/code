    ...
    <div class="col-md-12">
        ...
        <div class="box-body ztree_table" >
            <div class="row" style="float: left; margin-left: 0px;width: 100%;">
                ...
                <div class="search">
                        <form id="find-page-orderby-form" action="${BasePath !}/SystemData/AddressSelect.do" method="post">
                ...
                <div class="box-header" style="float: left;padding-left: 0px;width: 99%; ">
                        <table class="table table-hover table-striped bor2 table-common" id="TreeTable">
                            ...
                            <#list treeTable as item >
                                <tr ondblclick="ff.select.select({address_id:'${(item.id)!}',address_name:'${item.name}'})" >
...
<script type="text/javascript">
    ...
    var tree_setting = {
    	...
    	function beforeClick(treeId, treeNode) {
    		window.location.href = rootPath+"/SystemData/AddressSelect.do?id="+treeNode.id;
    		return true;
    	}

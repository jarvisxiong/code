...
function openAssignUserPage() {
	...
	$.frontEngineDialog.executeIframeDialog('select_user_to_role', '分配用户', url, '700', '510');
}
...
function openAssignUserGroupPage() {
	...
	$.frontEngineAjax.executeAjaxPost(
        ...
        function(ret) {
            var zNodes = ret;
            var content = '<div class="zTreeDemoBackground left" style="width: 250px; height: 450px;"><ul id="role_tree" class="ztree"></ul></div>';

       ...
       <div class="col-md-12">
           <div class="tab-content">
               <div class="tab-pane fade in active" id="myAccount">
                   <div class="col-md-12">
                        <div class="search">
                        <form id="find-page-orderby-form" action="${BasePath !}/stock/listSelectVendor.do" method="post">
...
<script type="text/javascript">
	...
	function getUpdata(v_id,v_name,v_code) {
		...
		//关闭弹窗窗
	    var $close=$(parent.document.getElementById('title:vendor_select_stock')).prev();
	    $close.click();
	}
</script>
</body>

...
public class Commodity extends DataEntity<Commodity> {
	...
	/**
	 * @return the commodityDummyType
	 */
	public String getCommodityDummyType() {
		return commodityDummyType;
	}

	/**
	 * @param commodityDummyType the commodityDummyType to set
	 */
	public void setCommodityDummyType(String commodityDummyType) {
		this.commodityDummyType = commodityDummyType;
	}

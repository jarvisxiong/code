...
public class StockCustomUsed extends DataEntity<StockCustom>{
	...
	private StockCustom stockCustom; //库存自定义id
	
	private String currStockNum;//对应仓库当前库存
	
	public StockCustomUsed(){
	}
	...
	public StockCustom getStockCustom() {
		if(stockCustom==null){
			stockCustom= new StockCustom();
		}
		return stockCustom;
	}

	public void setStockCustom(StockCustom stockCustom) {

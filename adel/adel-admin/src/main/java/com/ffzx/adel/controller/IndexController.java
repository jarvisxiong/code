...
public class IndexController {
    ...
    public Object getMenuListByUserId(HttpServletRequest request, HttpServletResponse response) {
        ...
        menu.put("url","/kart-admin/User/toList.do");
        menu.put("name","用户管理");
        ...
        menuVehicle.put("url","/kart-admin/Vehicle/toList.do");
        ...
        menuActivity.put("url","/kart-admin/Activity/toList.do");
        ...
        menuOrderInfo.put("url","/kart-admin/OrderInfo/toList.do");
        ...
        menuVerificationCode.put("url","/kart-admin/OrderInfo/toVerificationCode.do");

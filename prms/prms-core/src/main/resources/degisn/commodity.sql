...
(
	...
	-- 商品描述
	description varchar(6000) COMMENT '商品描述',
	-- 商品图标
	...
	-- 商品类别名称
	categoryAttribute_name varchar(100) COMMENT '商品类别名称',
	PRIMARY KEY (id),
	UNIQUE (code)
) COMMENT = 'commodity' DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
(
	...
	PRIMARY KEY (id)
) COMMENT = 'commodity_sku' DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

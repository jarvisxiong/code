...
public class SendNewUserCouponThread implements Callable<String>{
	private final static Logger logger = LoggerFactory.getLogger(SendNewUserCouponThread.class);
	...
	private CouponGrant grant;
	 public SendNewUserCouponThread(MemberApiService memberApiService,List<CouponAdminCouponGrant> couponGrantList,CouponReceiveService couponReceiveService
			 ,Map<String, Object> memberParams,CouponGrant grant) {
	...
	public String call() throws Exception {
		...
		if(memberList!=null && memberList.size()>0){
	    	for (CouponAdminCouponGrant couponAdminCouponGrant : couponGrantList) {
		    	...
		    	couponReceiveService.insertUserGrantCoponUpdateUser(couponReceives, updateMembers,true);
			}
		}
		return null;

...
requirejs.config({
	...
	paths: {
		...
		'ff/datatable': 'lib/datatable/js/dataTables.bootstrap',
		'ff/init_datatable': 'lib/datatable/js/init_datatable',
	...
	shim: {
		...
		'bs/multiselect': {deps: ['css!bs/css/multiselect.css'], exports: '$.fn.multiselect'},
		...
		'ff/init_datatable': {deps: ['ff/datatable']},

	    ...
	    <div class="col-lg-10 col-md-12 col-sm-12">
	        ...
	        <div class="addForm1"><br></br>
	            ...
	            <div class="form-tr">
	                <div class="form-td">
	                    <label><i>*</i>出库仓库选择：</label>
							<div class="div-form">
						<input type="radio" name="storageType" id="storageType"  checked="checked" value="0"   <#if (give.storageType) ??><#if give.storageType == '0'>checked="checked"</#if></#if>>
						中央仓
	            ...
	            <div class="form-tr">
	             ...
	             <div class="form-tr">
	                <div class="form-td">
	                    <label><i>*</i>触发数量：</label>
	                       ...
	                       Placeholder="请填写触发数量"
	                        data-rule-isIntGtZero="true" data-msg-isIntGteZero="限定数量为大于等于0的整数"  data-rule-isInteger="true" data-msg-isInteger="限定数量必须是整数" />   
	             ...
	             <div class="form-tr">
	                <div class="form-td">
	                    <label><i></i>ID 限购量：</label>
	                        ...
	                        Placeholder="不填则为不限购"
	                        type="text" id="idLimit" name="idLimit" value="${(give.idLimit) !}" data-rule-isIntGtZero="true"  data-msg-isIntGteZero="限定数量为大于等于0的整数"  data-rule-isInteger="true" data-msg-isInteger="限定数量必须是整数" />   
	             ...
	             <div class="form-tr">
	                <div class="form-td">
	                    <label><i>*</i>主商品选择：</label>
							<div class="div-form">
	                        
	                    <input id="" class="btn btn-primary btn-sm btn-inquire"
	                     onClick='checkmain()' type ="button" value="选择主商品" / >   
	                     <input type="hidden" id="giveCommodityId">      
	       	 			</div>
	                </div>
	             </div>
	             ...
	             <div class="form-tr">
	                <div class="form-td">
	                    <label><i>*</i>赠品选择：</label>
							<div class="div-form">
						<input type="radio" name="zpSelect" id="zpSelect" value="0"  >
						商品
						<input type="radio" name="zpSelect" id="zpSelect"  value="1"  >
						优惠券
	                    <input  class="btn btn-primary btn-sm btn-inquire"
	                   onclick="checkzp()"   type ="button" value="选择赠品" / >  
	                </div>
	             </div>
	               ...
	               <div class="form-tr"  >
	                <div class="form-td">
	                    <label><i></i>主商品：
                        <input class="form-control input-sm txt_mid" 
                               type="hidden" id="commodityId" name="commodityId" value="${give.commodityId!}" >
                                </label><!--hidden-->
						...
						<table class="table table-hover table-striped bor2 table-common" >
							...
							<tbody id="tabletdmain">
								...
								<td>
								<input  type="text" name="limitCount" id="limitCount"  class="limitCount"  style="width:80px;"  
	               ...
	               <div class="form-tr" id="selectuser1" >
	                <div class="form-td">
	                    <label><i></i>赠品（商品）：
	                     <input class="form-control input-sm txt_mid" 
                               type="hidden" id="commodityCommoditySku" name="commodityCommoditySku" value="${give.commodityCommoditySku!}" > 
                         <input class="form-control input-sm txt_mid" 
                               type="hidden" id="commodityCommoditySkuNum" name="commodityCommoditySkuNum" > 
						...
						<table class="table table-hover table-striped bor2 table-common ">
							...
							<tbody id="tabletdsku">
								...
								<input  type="text" name="giftLimtCount${item_index + 1}"   
    							 style="width:80px;"    value="${(item.limitCount) !}"
    							   class="giftLimtCount"  skuid="${(item.skuid) !}"  data-rule-isIntGtZero="true"  data-msg-isIntGtZero="限定数量为大于0的整数"  data-rule-isInteger="true" data-msg-isInteger="限定数量必须是整数" >
								</td>
								...
								<td><input  type="text" name="giftCount${item_index + 1}"  
    							  style="width:80px;"  value="${(item.giftCount) !}" class="giftCount" data-rule-required="true" data-msg-required="单次赠送数量不能为空"
    							    data-rule-isIntGtZero="true"  data-msg-isIntGtZero="单次赠送数量为大于0的整数"  data-rule-isInteger="true" data-msg-isInteger="单次赠送数量必须是整数" >
    							</td>
	               ...
	               <div class="form-tr"  >
	                <div class="form-td">
	                    <label><i></i>赠品（优惠券）：
                        <input class="form-control input-sm txt_mid" 
                               type="hidden"  id="couponAdminList" name="couponAdminList" value="${give.couponAdminList!}" > </label>
						...
						<table class="table table-hover table-striped bor2 table-common" >
							<thead>
								<tr>
							        <th width="30px">优惠券编码</th>
									<th width="25px">优惠券名称</th>
									<th width="25px">面值</th>
									<th width="100px">消费限制</th>
									<th width="230px">有效期</th>
									<th width="15px">操作</th>
								</tr>
							</thead>
...
<#include "../common/select.ftl" encoding="utf-8">
	...
	<script type="text/javascript" src="${BasePath !}/asset/js/activityGive/activityGive_form.js?v=${ver !}"></script>

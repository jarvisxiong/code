...
<body>
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="memberList">
			<div class="col-md-12">
				<div class="search">
					<form id="find-page-orderby-form" action="${BasePath !}/newUserActivity/toCommdity.do" method="post">
						...
						<div class="inquire-ul">
							<div class="form-tr">
								<div class="form-td">
									<label>商品名称：</label> 
										<div class="div-form"><input id="name" name="name" class="form-control txt_mid input-sm" type="text" placeholder="" value="${(commodity.name) !}">							
									</div>
								</div>
								<div class="form-td">
									<label>商品条形码：</label> 
										<div class="div-form"><input id="barCode" name="barCode" class="form-control txt_mid input-sm" type="text" placeholder="" value="${(commodity.barCode) !}">							
									</div>
								</div>
								<div class="form-td">
									<div class="btn-div3">
	...
	<script type="text/javascript" src="${BasePath !}/asset/js/activity/newuser_activity_select_goods.js?v=${ver !}"></script>
</body>
</html>

...
<body>
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="memberList">
			<div class="col-md-12">
				<div class="search">
					<form id="find-page-orderby-form" action="${BasePath !}/ordinaryActivity/toSelectCommdity.do" method="post">
	...
	<script type="text/javascript" src="${BasePath !}/asset/js/activity/ordinary/ordinary_select_goods.js?v=${ver !}"></script>
</body>
</html>

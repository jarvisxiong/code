...
<body><ul class="nav nav-tabs">
    <li class="active"><a href="#">抢购活动查看</a></li>
</ul>
					...
					<div class="addForm1">
						...
						<div class="form-tr">
							<div class="form-td">
								...
								<div class="div-form">
									<input id="title" name="title" disabled="disabled" value="${(activity.title) !}" style="width:450px;" class="form-control input-sm txt_mid" type="text" >
								</div>
							</div>
						</div>
						<div class="form-tr">

...
<body>
	...
	<div class="tab-content">
		<div class="tab-pane fade in active" id="memberList">
			<div class="col-md-12">
				<div class="search">
					<form id="find-page-orderby-form" action="${BasePath !}/couponGrant/couponAdminList.do" method="post">
	...
	<script type="text/javascript" src="${BasePath !}/asset/js/coupon/coupon_grant_admin_list.js?v=${ver !}"></script>

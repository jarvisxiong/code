...
<body>
 <ul class="nav nav-tabs" style="padding-left: 1%;">
      <li class="active"><a href="#">查看红包发放</a></li>
  </ul>
					           ...
					           <ul></ul>
					            ...
					            <div class="form-tr">
					                <div class="form-td">
					                    ...
					                    <div class="div-form">
					                        <input class="form-control input-sm txt_mid"  type="text" id="name" name="name" value="${(redpackageGrant.name) !}"   data-rule-required="true" data-msg-required="优惠券名称不能为空"                      
					       	 			</div>
					                </div>
					              </div>
				              	  <div class="form-tr">
					                ...
					                <div class="form-td">
										...
										<table class="table table-hover table-striped bor2 table-common">
											...
											<tbody id="admintabletd">
												<#if (redpackageGrant??) && (redpackageGrant.redpackageHandles??) > 
												<#list redpackageGrant.redpackageHandles as item >
												<tr>
...
$(function(){
       ...
       $(".btn-close-iframeFullPage").removeAttr("disabled");
    }); 
</script>
</body>
</html>
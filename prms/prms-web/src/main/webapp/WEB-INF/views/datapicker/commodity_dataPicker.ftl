...
<body>
		...
		<div class="tab-pane fade in active">
			...
			<div class="row">
				<div class="col-lg-10 col-md-12 col-sm-12">
					<form id="myform" action="${BasePath !}/dataPicker/commodity_dataPicker.do" method="post">
					        <input id="find-page-index" type="hidden" name="pageIndex" value="1" />
					        <input id="find-page-size" type="hidden" name="pageSize" value="${(pageObj.pageSize) !}" />
							<input id="find-page-count" type="hidden" value="${(pageObj.pageCount) !}" />
						<div class="inquire-ul" style="margin-top:0;">
							<div class="div-form"><input id="barCode" name="barCode"    placeholder="商品条码"  onblur="this.value=$.trim(this.value);" value="${(params.barCode) !}"
	...
	$.frontEngineDialog.executeIframeDialog('commodity_dataPicker', 'shangpin', rootPath
   		...
   		function onEmpty() {
   			location.href="${BasePath !}/dataPicker/commodity_dataPicker.do?clearParams=YES";  
   		}
